...
const PopularProducts = () => {
  ...
  const fetchPopularProducts = async () => {
    ...
    try {
      ...
      setPopularProducts(response.productItemList);
    } catch (error) {
      setError(error?.msg || "Không thể tải sản phẩm phổ biến. Vui lòng thử lại sau.");
      toast.error(error?.msg || "Không thể tải sản phẩm phổ biến. Vui lòng thử lại sau.");
    } finally {
      setIsLoading(false);
    }
  };
